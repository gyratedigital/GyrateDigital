                    ...
                    {servicesSection.map((service) => (
                        <div
                            ...
                            className="card relative group flex w-[78vw] max-w-[420px] shrink-0 flex-col overflow-hidden
                                       bg-primary p-[30px] rounded-2xl shadow-md
                                       bg-[url('/card-bg.svg')] bg-[length:46%] bg-top-right bg-no-repeat
                                       transition-[background-size] duration-500 ease-in-out hover:bg-[length:80%]
