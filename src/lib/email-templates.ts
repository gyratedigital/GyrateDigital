    ...
    <div class="footer">
      ...
      <div style="margin-top: 20px; font-size: 14px; color: ${colors.text}; line-height: 1.6;">
        <p style="margin: 3px 0;">
          <a href="https://maps.google.com/?q=33+Copgrove+Road,+Leeds,+West+Yorkshire+LS8+2SP,+United+Kingdom" style="color: ${colors.text}; text-decoration: none;">33 Copgrove Road, Leeds, West Yorkshire LS8 2SP, United Kingdom</a>
        </p>
        <p style="margin: 15px 0 3px 0;"><strong>Phone:</strong> <a href="tel:+447943939124" style="color: #0066cc; text-decoration: underline;">+44 7943 939124</a></p>
